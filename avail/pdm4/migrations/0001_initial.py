# Generated by Django 4.2.9 on 2025-03-21 05:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, help_text='レコードが作成された日時', verbose_name='作成日時')),
                ('updated_at', models.DateTimeField(auto_now=True, help_text='レコードが最後に更新された日時', verbose_name='更新日時')),
                ('name', models.CharField(help_text='このノードの表示名', max_length=100, verbose_name='ノード名')),
                ('description', models.TextField(blank=True, help_text='このノードの説明', null=True, verbose_name='説明')),
                ('node_type', models.CharField(choices=[('root', 'ルートノード'), ('code', 'コードノード'), ('group', 'グループノード')], default='code', help_text='ノードの種類（ルート、コード、グループ）', max_length=20, verbose_name='ノードタイプ')),
                ('status', models.CharField(choices=[('draft', '下書き'), ('active', '有効'), ('obsolete', '廃止')], default='active', help_text='ノードの現在の状態', max_length=20, verbose_name='状態')),
                ('code', models.ForeignKey(blank=True, help_text='このノードに関連付けられた部品コード（ある場合）', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tree_nodes', to='pdm4.code', verbose_name='関連コード')),
            ],
            options={
                'verbose_name': 'ツリーノード',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('node', models.ForeignKey(help_text='このツリー構造のノード', on_delete=django.db.models.deletion.CASCADE, related_name='structures', to='pdm4.treenode', verbose_name='ノード')),
                ('parent', models.ForeignKey(blank=True, help_text='親ノードの構造（ルートノードの場合はnull）', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='pdm4.treestructure', verbose_name='親構造')),
                ...
                ('tree', models.ForeignKey(help_text='このノードが属するツリー', on_delete=django.db.models.deletion.CASCADE, related_name='nodes', to='pdm4.tree', verbose_name='所属ツリー')),
            ],
            options={
                'verbose_name': 'ツリー構造',
        ...
        migrations.AddIndex(
            model_name='treenode',
            index=models.Index(fields=['node_type'], name='pdm4_node_type_idx'),
        ),
        migrations.AddIndex(
            model_name='treenode',
            index=models.Index(fields=['status'], name='pdm4_node_status_idx'),
        ),
        migrations.AddIndex(
